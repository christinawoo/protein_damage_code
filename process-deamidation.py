...
with open("/Users/matthewsu/Desktop/Chimera Computations/chimera/deamidation/deamidation_pdbs_111123.json") as json_file:
...
with open('/Users/matthewsu/Desktop/Chimera Computations/chimera/deamidation/1-2000output_all_111123.json', 'w', encoding='utf-8') as f:
    json.dump(data, f, ensure_ascii=False, indent=4)

# Write errors to error file
with open('/Users/matthewsu/Desktop/Chimera Computations/chimera/deamidation/1-2000errors_all_111123.csv', 'w') as csvfile:
...
with open('/Users/matthewsu/Desktop/Chimera Computations/chimera/deamidation/1-2000errors_alphafold_111123.csv', 'w') as csvfile:
    fwriter = csv.writer(csvfile)

    for x in alphafold_errors:
        fwriter.writerow(x)

with open('/Users/matthewsu/Desktop/Chimera Computations/chimera/deamidation/1-2000errors_all_failed_111123.csv', 'w') as csvfile:
    fwriter = csv.writer(csvfile)
