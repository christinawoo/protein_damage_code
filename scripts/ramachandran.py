"""
Script for calculating backbone torsion angles (phi and psi on a Ramachandran plot) for Asn and Gln residues.
"""
...
RAMACHANDRAN_ERRORS_CSV_FILEPATH = ""
...
with open(RAMACHANDRAN_ERRORS_CSV_FILEPATH, 'w') as csvfile:
