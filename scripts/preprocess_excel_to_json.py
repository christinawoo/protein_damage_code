"""
  ...
  For use with analyze_cleaved_N_Alphafold.py, the Excel spreadsheet should contain the following columns:
    ...
    gene_name_and_position: Required. Concatenated Uniprot accession of protein and the position of Asn/Gln to be analyzed. E.g., for Uniprot accession P00761 and Asn position 105, gene_name_and_position should be P00761105.
