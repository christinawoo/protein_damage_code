"""
  Script for converting .xlsx files to .json files, primarily for use as input to recalculate.py.

  For use with recalculate.py, the Excel spreadsheet should contain the following columns:
