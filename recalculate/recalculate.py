"""
    ...
    The input to this script should be a JSON file obtained from preprocess_recalculate.py, which should accept an Excel file containing the following columns:
