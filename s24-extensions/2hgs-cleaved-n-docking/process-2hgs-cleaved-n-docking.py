...
def analyze(gene_name_and_position, chain, aa_position):
    ...
    # Load structure
    # Load pdb
    runCmd(f'open "/Users/matthewsu/Desktop/Chimera Computations/chimera/s24-extensions/2hgs-cleaved-n-docking/2hgs alphafold results/prediction/selected_prediction.pdb"')
...
with open("/Users/matthewsu/Desktop/Chimera Computations/chimera/s24-extensions/2hgs-cleaved-n-docking/2hgs_cleaved_initial.json") as json_file:
...
with open('/Users/matthewsu/Desktop/Chimera Computations/chimera/s24-extensions/2hgs-cleaved-n-docking/2hgs_cleaved_results.json', 'w', encoding='utf-8') as f:
